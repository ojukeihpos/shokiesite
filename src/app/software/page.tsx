"use client"
import React, { Component, createRef, Suspense, useRef, useState } from 'react';
import Link from 'next/link';
import Loading from './loading';
import ScrollToTopButton from '../scrollToTop';

export default class Professional extends Component<{}, { btnText: string }> {
    scrollableDivRef: React.RefObject<HTMLDivElement>;
    content: HTMLCollectionOf<HTMLElement> | null = null;

    pageContent = <><div className='shoka__header'>
        <div id='titlehead'>
        ...
        <div className='about text-justify'>
            <p>{"Hello! I'm Sophie. I have a Bachelor of Science in Computer Science (BSc.), and work as a software engineer.\n"}</p>
    ...
    constructor(props: {}) {
        super(props)
        this.scrollableDivRef = createRef<HTMLDivElement>()
    }
    render() {
        return <Suspense fallback={<Loading />}>
            ...
            <div id="desktop-component" className="hidden lg:inline">
                <ScrollToTopButton scrollableDivRef={this.scrollableDivRef} />
                <Link prefetch href="/">
                    <div className='exit-button clickable mr-5'>Back</div>
                </Link>
                <div className='content'  >
                    <div className='shoka__header' />
                    <div className='page-content mr-5' ref={this.scrollableDivRef}>
                        {this.pageContent}
                    </div>
                </div>
            </div>
